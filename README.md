...
回响册是一款默认保存在当前浏览器的个人演出记录 PWA。它不是一张只有标题和日期的清单，而是围绕演出中最值得保存的媒介设计：主海报、电子票根、座位图、现场精选照片，以及多艺人阵容、票价座位和同行记忆。
...
- 10 种浏览方式：海报、票夹、纪念票根、时间线、票价、汇总、日历、场馆/城市、列表等；海报墙支持自定义每行数量。
...
- 可选择保存位置：当前浏览器，或连接自己的 Supabase 做私人跨设备同步。
