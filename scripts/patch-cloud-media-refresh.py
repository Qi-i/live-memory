...
"insert cloud media refresh state",
)
...
"replace cloud media refresh key",
)
...
"replace cloud media refresh effect",
)
...
"replace media image failure handling",
)
...
'''  async function handleRestoreFromCloud() {
  ...
  return (''',
"insert manual cloud media refresh handler",
)
...
"insert manual cloud media refresh button",
)
